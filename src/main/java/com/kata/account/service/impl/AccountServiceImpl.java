...
public class AccountServiceImpl implements AccountService {
    ...
    public Set<Account> getAccounts() {
        return ephemeralStorageServiceImpl.getAccounts();
    }

    public String postAccount(Account account) {
        return ephemeralStorageServiceImpl.postAccount(account);
    }
    ...
    public String balanceDeposit(PostBalanceRequestBody postBalanceRequestBody)
        ...
        ephemeralStorageServiceImpl.addTransaction(
        ...
        return ephemeralStorageServiceImpl.putAccount(account);
    ...
    private Account checkExistingAccount(String accountId) throws AccountNotFoundException {
        Account account = ephemeralStorageServiceImpl.getAccountById(accountId).orElse(null);
        if (account != null) {
            return account;
        } else {
